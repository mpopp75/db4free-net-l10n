...
$translations = array(
    'email' => 'db4free.net hesabınızı kaydettirdiğiniz için teşekkürler {$user}.

Aşağıdaki linki onayladıktan sonra, db4free.net\'in MySQL 5.6 veritabanı sunucularına erişiminiz olacaktır. Sunucuya erişmek için host adı: db4free.net ve port: 3306 (MySQL için varsayılan port) olacaktır. Websitemizdeki phpMyAdmin panelini kullanarak sunucuya giriş yapabilirsiniz.
...
* eğer uyarılara rağmen db4free.net veritabanını üretimde kullanırsanız, bunun sorumluluğu size aittir (Sık yedeklemeler şiddetle önerilir)
