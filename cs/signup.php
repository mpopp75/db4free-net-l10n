...
$translations = array(
    ...
    'mysql-user-name' => 'MySQL Jméno',

    'mysql-user-password' => 'MySQL Heslo',

    'mysql-user-password-verification' => 'MySQL Ověření hesla',
    ...
    'explanation' => 'Uživatelské databáze a název databáze musí obsahovat malá písmena, číslice a podtržítko a musí být déleku mezi 4 a 16 znaky. Nesmíte používat <a href="https://dev.mysql.com/doc/refman/5.7/en/reserved-words.html">vyhrazená slova</a>!',
    ...
    'agm-li9' => 'db4free.net je služba pro testování, nikoli pro hosting. Databáze, které uchovávají více než 200 MB dat bude vymazány v nepravidelných intervalech bez předchozího oznámení',

    'agm-li10' => 'Prosím, odstraňte data, která jsou již nepotřebná, nebo <a href="/delete-account.php">smazat účet v případě neaktivity</a>.',

    'signup-error1' => 'Musíte souhlasit s podmínkami použití!',

    'signup-error2' => 'Chyba registraci dat pro databázi MySQL!',
