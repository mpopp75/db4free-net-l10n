...
$translations = array(
    ...
    'p1a' => 'db4free.net fornisce un servizio di testing per l\'ultima - a volte ancora in sviluppo - versione di <a href="http://www.mysql.com/">MySQL Server</a>. Puoi facilmente <a href="/signup.php">creare un account gratuito</a> e testare le tue applicazioni ed essere sicuro che esse continueranno a funzionare quando aggiornerai la versione di MySQL. db4free.net è anche un\'ottima risorsa per imparare ad usare le nuove funzioni introdotte nelle nuove versioni di MySQL.',
