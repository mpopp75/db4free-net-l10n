...
$translations = array(
    ...
    'l10ncredits' => 'Ringraziamenti a coloro che hanno contribuito alle traduzioni',
    ...
    'p2e' => 'Ci raccomandiamo di creare un branch separato per la tua traduzione, ad esempio:',

    'p2f' => 'git checkout -b mytranslations',

    'p2g' => 'Se non esiste una directory per il linguaggio di cui vuoi creare la traduzione, crea una copia della cartella "en" e chiamala come previsto da <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes">ISO 639-1 Codici Linguaggi</a>.',

    'p2h' => 'Nei files in questa cartella, sostituisci i testi in inglese con i testi nel nuovo linguaggio. Si prega di prestare attenzione a non modificare l\' ID della traduzione. Per esempio sostituisci:',

    'p2i' => '\'h1\' => \'Welcome to db4free.net\',',

    'p2j' => 'con',

    'p2k' => '\'h1\' => \'Benvenuto su db4free.net\',',
