...
$translations = array(
    ...
    'id-not-found' => 'ID không tìm thấy.',

    'success-create-db' => 'Cơ sở dữ liệu được tạo thành công.',

    'error-create-db' => 'Lỗi tạo cơ sở dữ liệu.',

    'success-data-change' => 'Dữ liệu đã được thay đổi.',
    ...
    'another-user-username' => 'Tên người dùng đã được đăng ký bời người khác: ',
    ...
    'confirmation-email' => 'Bạn sẽ nhận được một email để xác nhận thay đổi.',

    'error-write-data' => 'Lỗi đã xảy ra việc trong khi cập nhật dữ liệu của bạn.',
