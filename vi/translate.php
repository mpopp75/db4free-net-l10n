...
$translations = [
    ...
    'h2' => 'Cách làm như thế nào?',

    'p2a' => 'Trước tiên, bạn cần phải đăng ký một tài khoản GitHub, trừ khi bạn đã có một. Fork từ repository tại',

    'p2b' => '<a href="https://github.com/mpopp75/db4free-net-l10n">https://github.com/mpopp75/db4free-net-l10n</a>',

    'p2c' => ' bây giờ bạn có một bản sao của repository trong tài khoản của bạn. Bây giờ bạn có thể sao chép repository của bạn để tạo ra một bản sao trên máy tính của bạn. Các lệnh Git cho việc này là:',

    'p2d' => 'git clone git@github.com:[tai_khoan_github]/db4free-net-l10n.git',

    'p2e' => 'Chúng tôi khuyên bạn nên tạo một branch riêng biệt cho bản dịch của bạn, như sau:',

    'p2f' => 'git checkout -b branchcuaban',

    'p2g' => 'Nếu không có thư mục cho ngôn ngữ mà bạn muốn dịch, tạo một bản sao của thư mục "en" và đặt tên nó theo <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes">bảng mã ngôn ngữ ISO 639-1</a>.',
