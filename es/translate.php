...
$translations = array(
    ...
    'p1b' => 'Todos los textos de la página web están en <a href="https://github.com/">GitHub</a>. Usted puede realizar un fork del repositorio, aplicar sus traducciones y enviarnos un pull request para que sus traducciones puedan ser integradas en el sitio web.',

    'h2' => '¿Cómo funciona?',

    'p2a' => 'Primero tendrá que registrarse para obtener una cuenta de GitHub, a menos que ya tenga una. Haga un fork del repositorio ',
    ...
    'p2g' => 'Si no hay un directorio para el idioma que desea aplicar a las traducciones, haga una copia del directorio "en" y nómbrelo de acuerdo a <a href="http://es.wikipedia.org/wiki/ISO_639-1">los códigos de lenguajes ISO 639-1</a>.',
