...
$translations = array(
    ...
    'p1a' => 'db4free.net ofrece un servicio de pruebas para la última versión - a veces en desarrollo - del <a href="http://www.mysql.com/">servidor MySQL</a>. Usted puede fácilmente <a href="/signup.php">crear una cuenta gratis</a> y probar sus aplicaciones, por ejemplo para asegurarse de que siguen funcionando después de una actualización de la versión de MySQL. db4free.net es también un buen recurso educacional y para que se familiarice con las nuevas características que se han introducido en las nuevas versiones.',
    ...
    'p2' => 'Usted puede notar que <b>aquí todo es nuevo</b>. <a href="http://www.mpopp.net/2014/07/db4free-net-relaunch/">Para saber más al respecto!</a>',

    'h3' => 'Lo que no es db4free.net',

    'p3' => 'db4free.net es un <b>servicio de prueba</b> lo que significa que no es adecuado para la producción. Puede haber interrupciones, pérdida de datos y funciones de seguridad que no cumplen con los estándares que usted espera de un proveedor de hosting de datos profesional. Si usted necesita una base de datos MySQL para uso en producción, por favor no utilice db4free.net!',

    'h4' => '¿Puedes ayudar a traducir db4free.net?',

    'p4' => '¿Habla bien un lenguaje que este sitio web no ofrece? Usted puede ayudarnos a traducir db4free.net. <a href="/translate.php">Descubre cómo!</a>',
