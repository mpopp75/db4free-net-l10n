...
$translations = array(
    'email' => 'Gracias por registrar su cuenta de base de datos {$user} en db4free.net.

Después de confirmar el enlace de abajo, usted tendrá acceso al servidor de base de datos MySQL 5.7 de db4free.net. El nombre de host para acceder al servidor es db4free.net y el puerto es el 3306 (que es el puerto por defecto para MySQL). Puede usar phpMyAdmin en nuestro sitio web para iniciar sesión en el servidor.
...
* db4free.net no es adecuado para la producción
...
* pérdida de datos e interrupciones pueden ocurrir en cualquier momento (alguna queja acerca de eso es probable que se ignoran)
...
¿Puedes ayudar a traducir el sitio web de db4free.net? Por favor, vaya a http://www.db4free.net/translate.php

Si no fue usted quien ha registrado una cuenta de base de datos en la página web de db4free, por favor ignora este correo electrónico!
