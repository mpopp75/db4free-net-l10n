...
$translations = array(
    'email-signup' => 'Thank you for registering your database account {$user} with db4free.net.

After confirming the link below, you have access to db4free.net\'s MySQL 8.1 database server. The host name to access the server is db4free.net and the port is 3306. You can use phpMyAdmin on our website to log in to the server.
