...
$translations = [
    ...
    'p1c' => 'Para acessar seus dados de maneira conveniente, o db4free.net também oferece uma versão atualizada do <a href="https://www.phpmyadmin.net">phpMyAdmin</a>. O phpMyAdmin também será atualizado regularmente para que você sempre tenha a versão mais recente.',

    'h2' => 'O que o db4free.net não é',

    'p2' => 'O db4free.net é um <b>serviço de testes</b>, o que significa que não é destinado a produtos finais. Pode haver quedas de energia, perda de dados e não serão implementadas todas as funcionalidades de segurança esperadas em serviços de hospedagem. Se você precisa de um servidor MySQL para um produto final, não utilize o db4free.net!',

    'h3' => 'Você pode ajudar a traduzir o db4free.net?',

    'p3' => 'Você fala bem um idioma que não está disponível neste site? Você pode ajudar a traduzir o db4free.net. <a href="/translate.php">Saiba como!</a>',
