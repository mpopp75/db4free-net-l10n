...
$translations = array(
    ...
    'p1c' => 'Para acessar os seus dados de uma maneira mais conveniente, o db4free.net também disponibiliza uma versão atualizada do <a href="https://www.phpmyadmin.net">phpMyAdmin</a>. O phpMyAdmin também será atualizado frequentemente, para que você sempre tenha a versão mais atual.',

    'h2' => 'O que o db4free.net não é',

    'p2' => 'db4free.net é um <b>serviço de testes</b> o que siginifica que não é feito para produtos finais. Podem haver quedas de energia, perda de dados e não haverá funcionalidades de segurança esperadas em serviços de hospedagem. Se você precisa de um servidor MySQL para produto final, não use o db4free.net!',

    'h3' => 'Você pode ajudar a traduzir o db4free.net?',

    'p3' => 'Você fala bem um idioma que esse site não disponibiliza? Você pode ajudar a traduzir o db4free.net. <a href="/translate.php">Descubra como!</a>',
