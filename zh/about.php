...
$translations = array(
    ...
    'p2' => '该项目致力于提供<b>最新版本</b>的MySQL数据库以满足开发者和测试者的需求。 当每次 MySQL 及 phpMyAdmin 版本更新时，你将可以测试自己的网站是否兼容最新版本的MySQL。',

    //'h3' => '<a href="signup.php">Get your own free MySQL database account&nbsp;&raquo;</a>',
	'h3' => '<a href="signup.php">马上建立你的免费MySQL账号&nbsp;&raquo;</a>',
);
?>
