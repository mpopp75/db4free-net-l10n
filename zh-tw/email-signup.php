...
$translations = array(
    'email-signup' => '感謝你在db4free.net註冊了資料庫帳號 {$user}.

當你點擊下面的帳號確認連結後，你將擁有存取db4free.net\'s MySQL 8.0 資料庫伺服器的權限。 存取的網域名稱為：db4free.net 以及 port為：3306。 你也可以利用網站介面phpMyAdmin來連接資料庫伺服器。

請點擊以下的連結來完成註冊程序，連結有效時間為14天。<br>點下連結代表你同意並了解下列條款：

* db4free.net 僅供測試環境使用。
* db4free.net 不適用於商業用途。
* 盡管以上諸多警告，如果你仍決定在生產環境下使用db4free.net資料庫，所有風險將自行承擔。(強烈建議定時備份)
