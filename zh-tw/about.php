...
$translations = [
    ...
    'p2' => '本計畫致力於提供<b>最新版本</b>的 MySQL 資料庫以滿足開發者及測試者的需求。隨著每次 MySQL 及 phpMyAdmin 更新版本時，您將可以測試自己的網站是否相容於最新版本的 MySQL。',

    //'h3' => '<a href="signup.php">Get your own free MySQL database account&nbsp;&raquo;</a>',
    'h3' => '<a href="signup.php">馬上建立您的免費 MySQL 資料庫帳號&nbsp;&raquo;</a>',
];
