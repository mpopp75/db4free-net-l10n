...
$translations = array(
    ...
    'p1' => 'Em nenhuma hipótese, nós, equipe db4free.net, devemos ser responsabilizados perante quaisquer partes por danos diretos, indiretos, especiais, acidentais ou por danos, incluindo, mas não limitado a: perda de lucro, decorrentes do uso ou da indisponibilidade deste servidor, o seu software, seus serviços ou a sua documentação, mesmo que o administrador tenha sido avisado da possibilidade de tais danos.',
    ...
    'p3' => 'Não é permitido os usuários do db4free.net publicar seus dados de acesso, tal como, dados especificos do servidor para terceiros.',

    'p4' => 'Apenas as leis da República da Austria se aplicam aos serviços relacionados ao projeto db4free.net.',

    'p5' => 'Não recomendamos o uso dos bancos de dados do db4free.net para qualquer dado ou objetivos importantes! Mesmo que nós - pessoas envolvidas nesse projeto - estamos envolvidos um com os outros através de uma empresa, o projeto continua sendo privado e não-comercial. Nos isentamos de qualquer garantia e culpa.',
    ...
    'p8' => 'Heidenreichstein, Austria<br>29 de Junho de 2014',
);
?>