...
Après avoir confirmé en cliquant sur le lien suivant, vous avez accès au serveur MySQL 8.1 de db4free.net. Le nom d\'hôte pour accéder au serveur est db4free.net et le port est 3306. Vous pouvez utiliser phpMyAdmin sur notre site pour vous connecter au serveur.
...
* si vous décidez d\'utiliser votre base de données db4free.net en production malgré les avertissements, vous le faites à vos risques et périls (des sauvegardes fréquentes sont très vivements recommandées)
