...
$translations = array(
    ...
    'l10ncreditsclick' => 'Klicka för att visa listan',
    ...
    'p2c' => ' för att du skall ha en identisk kopia av översättningarna på ditt konto så kan du nu skapa en klon av projektet till din egen dator. Git kommandot för att göra detta är:',

    'p2d' => 'git clone git@github.com:[Ditt_GitHub_användarnamn]/db4free-net-l10n.git',

    'p2e' => 'Vi rekommenderar att du skapar en separat "branch" för din översättning, här är ett exempel:',

    'p2f' => 'git checkout -b MinOversattning',
