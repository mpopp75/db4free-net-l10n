...
$translations = array(
    'h1' => 'Selamat datang di db4free.net',
    ...
    'p1c' => 'Untuk mengakses data Anda secara nyaman, db4free.net juga menyediakan sebuah versi terbaru dari <a href="https://www.phpmyadmin.net">phpMyAdmin</a>. phpMyAdmin juga akan selalu ter-update, jadi Anda akan selalu menggunakan versi terbarunya.',

    'h2' => 'Apa db4free.net tidak baik untuk produksi',

    'p2' => 'db4free.net adalah <em>layanan tes</em> yang berarti tidak baik untuk produksi. Di mana server dapat mati, atau Anda kehilangan data dan fitur keamanan tidak memenuhi standar yang Anda harapkan layaknya penyedia data hosting profesional. Jika Anda ingin menggunakan MySQL database untuk penggunaan produksi, harap tidak menggunakan db4free.net!',

    'h3' => 'Apakah Anda dapat membantu menerjemahkan situs db4free.net?',

    'p3' => 'Apa Anda berbicara lancar dengan bahasa yang tidak disediakan di situs ini? Anda dapat membantu kami menerjemahkan situs db4free.net. <a href="/translate.php">Lihat caranya!</a>',
