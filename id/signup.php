...
$translations = [
    ...
    'mysql-user-name' => 'Nama pengguna MySQL',

    'mysql-user-password' => 'Kata sandi pengguna MySQL',

    'mysql-user-password-verification' => 'Verifikasi kata sandi pengguna MySQL',

    'email-address' => 'Alamat Email (Surel)',
