...
Nach Bestätigung des folgenden Freischaltungs-Links, haben Sie Zugriff auf db4free.net\'s MySQL 5.6 Datenbank-Server. Um auf den Server zugreifen zu können, müssen Sie als Hostnamen db4free.net und als Port 3306 (welches der MySQL Standard-Port ist) eingeben. Sie können auch phpMyAdmin auf unserer Website verwenden, um auf den Server zuzugreifen.
...
* wenn Sie sich dennoch entscheiden, Ihre db4free.net-Datenbank für produktive Zwecke zu verwenden, dass dies auf eigene Gefahr geschieht (sehr häufige Backups werden sehr empfohlen)
