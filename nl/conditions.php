...
$translations = [
    ...
    'p2' => 'Wij wijzen specifiek alle garanties af, inclusief, maar niet beperkt tot, de impliciete garanties van verkoopbaarheid en geschiktheid voor een bepaald doel. De software en host die hieronder worden verstrekt, zijn op basis van "zoals het is", en wij hebben geen verplichtingen om onderhoud, ondersteuning, updates, verbeteringen of wijzigingen of voortdurende beschikbaarheid van diensten te bieden. We hebben het recht om deze service zonder kennisgeving stop te zetten en de databases onherroepelijk te verwijderen.',

    'p3' => 'Gebruikers van db4free.net mogen hun toegangsgegevens en server-specifieke gegevens niet publiceren aan derden.',

    'p4' => 'Uitsluitend het recht van de Republiek Oostenrijk is van toepassing op diensten met betrekking tot het db4free.net-project.',
